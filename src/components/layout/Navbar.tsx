...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { name: '¿Qué es Tianbot?', href: '#about' },
        ...
        <div className="flex items-center justify-between py-4">
          <div className="flex items-center">
            <a href="#home" className="text-2xl font-bold text-primary flex items-center gap-2">
              <span className="text-3xl">𝘁</span>
              <span>Tianbot</span>
            </a>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            >
              ...
              {showAccessibilityMenu && (
                <div className="absolute right-0 mt-2 w-60 bg-background border border-border rounded-md shadow-lg p-2 animate-fade-in">
                  <p className="px-3 py-2 text-sm font-medium">Opciones de accesibilidad</p>
                  <div className="border-t border-border my-1"></div>
                  <button
                    onClick={() => handleAccessibilityOption('contrast')}
                    className="w-full text-left px-3 py-2 hover:bg-muted rounded-md text-sm"
                  >
                    Alto contraste
                  </button>
                  <button
                    onClick={() => handleAccessibilityOption('text-size')}
                    className="w-full text-left px-3 py-2 hover:bg-muted rounded-md text-sm"
                  >
                    Texto grande
                  </button>
        ...
        {isOpen && (
          <div className="md:hidden py-4 animate-fade-in">
            <div className="flex flex-col space-y-3">
              ...
              {showAccessibilityMenu && (
                <div className="mt-2 bg-muted/50 border border-border rounded-md p-2">
